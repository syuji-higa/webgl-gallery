...
class MainObject {
  ...
  constructor(gl, matIV, dpr) {
     ...
     */
    {
      ...
      _gui.add(this._objectStatus, 'power', 0.0, 3.0);
      _gui.add(this._objectStatus, 'speed', 0.0, 3.0);
      _gui.add(this._objectStatus, 'scale', 0.0, 3.0);
      _gui.add(this._objectStatus, 'rgbShift', 0.0, 3.0);
    }
  ...
  draw(data) {
    ...
    _gl.uniform4fv(_ul[4], [os.power, os.speed, os.scale, os.rgbShift]); // object status
