...
class TextCanvas {
	 ...
	 */
	constructor(opts = {}) {
		const { canvasCls, fieldCls, fontFamily, fontSize } = Object.assign(TextCanvas._defOpts, opts);
		...
		this._inputEvt = createEvent(this._$field, 'input', this._onInput.bind(this));
	...
	_setTexture() {
		...
		this._ctx.fillText(_txt, this._width / 2, this._height / 2 + this._fontSize / 2);
