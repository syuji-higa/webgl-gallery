...
class WebGL {
	...
	constructor(opts = {}) {
      ...
      povx: 0, povy: 0,
		...
		this._gl =
			this._$canvas.getContext('webgl', _webglOpts) || this._$canvas.getContext('experimental-webgl', _webglOpts);
		...
		// event listener
		this._resizeEvt = EventObserver.getInstance().create(document, 'resize', this._resize.bind(this));
		this._heightResizeEvt = EventObserver.getInstance().create(document, 'heightResize', this._resize.bind(this));
	}
	...
	_render() {
      ...
      dox, doy, povx, povy,
		...
		// init view
		this._matIV.lookAt([-povx, povy, 1], [povx, -povy, 0], [0, 1, 0], this._vMat);
